...
<head>
    ...
    <title>Thanks For Registration {{ title }}</title>
    <meta name="description" content="Reset Password {{title}}.">
    <style type="text/css">
                ...
                <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                          <a href="{{ site_url }}" title="logo" target="_blank">
                            <img width="250" src="{{ logo }}" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Welcome to {{ title }} Family.</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Please Verify Email.
                                        </p>
                                        <a href="{{ email_verify_link }}"
