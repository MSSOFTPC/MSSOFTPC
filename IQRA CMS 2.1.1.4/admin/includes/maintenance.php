<?php 
$adminmaintenancemode = site_options('return_admin_maintenance_mode');
if($adminmaintenancemode == 1){?>
    <!doctype html>
...
<article>
    ...
    <div>
        ...
        <p>&mdash; The <?php echo site_options('return_title').' | '.'Powered by IQRA CMS';?> Team</p>
    </div>
</article>
<?php die(); }
